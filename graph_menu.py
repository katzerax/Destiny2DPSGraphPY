...
class graph_menu(tk.Frame):
    ...
    def __init__(self, master):
        ...
        self.frame_style = {'bg': '#1E1E1E', 'highlightcolor': '#000000', 'highlightbackground': '#000000', 'highlightthickness': 0}
    ...
    def wep_config(self):
        ...
        self.wep_widgets = [
                ...
                ttk.Combobox(self.config_frame, values=existing_weapons, **self.master.combo_style)
                ) for i in range(10)
            ]
        # Grid placement
        ...
        self.generate_button = tk.Button(self.config_frame, text="Generate Graph", state=gen_but_enabled,
    ...
    def graph(self):
        ...
        self.ax.set_facecolor(self.master.matplotlib_fg)
        self.fig.set_facecolor(self.master.matplotlib_fg)
    ...
    def set_numweapons(self, evt):
        ...
        ammount = int(self.graph_num_weps_combo.get()) - 1
